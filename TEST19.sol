...
contract TEST19 is Version, Owned {
     string public constant DESCRIPTION=string("Test Nineteen Token");
     string public name="Test Nineteen";
     string public symbol="TEST19";
